Contributing to Prufus
============================

The Prufus project operates an open contributor model where anyone is
...
The following applies to code changes to the Prufus project, and is not to be
confused with overall PRUFUS Network Protocol consensus changes.

Whether a pull request is merged into Prufus rests with the project merge
...
Patches that change PRUFUS consensus rules are considerably more involved than
...
Where a patch set proposes to change the PRUFUS consensus, it must have been
...
The project leader is the release manager for each Prufus release.
