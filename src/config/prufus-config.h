/* src/config/prufus-config.h.  Generated from prufus-config.h.in by configure.  */
/* src/config/prufus-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Prufus_CONFIG_H

#define Prufus_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.prufus.co"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Prufus Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Prufus Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "prufus"
