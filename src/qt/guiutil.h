...
/** Utility functions used by the PRUFUS Qt UI.
 */
namespace GUIUtil
{
...
// Render PRUFUS addresses in monospace font
...
// Parse "prufus:" URI into recipient object, return true on successful parsing
