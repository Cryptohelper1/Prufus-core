...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PRUFUS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and prufus: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Prufus"), this);
    aboutAction->setStatusTip(tr("Show information about Prufus"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PRUFUS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PRUFUS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PRUFUS addresses"));
    ...
    openAction->setStatusTip(tr("Open a PRUFUS: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Prufus help message to get a list with possible PRUFUS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Prufus client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PRUFUS network", "", count));
}
...
{
    QString strTitle = tr("Prufus"); // default title
