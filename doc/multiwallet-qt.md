...
In order to support loading of multiple wallets in prufus-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is prufus.cpp.
...
Changes to prufus.cpp
----------------------
prufus.cpp is the entry point into prufus-qt, and as such, will require some minor modifications to provide hooks for
